...
<script>
    function submitRegistration() {
        ...
        var rValues = {}
        rValues.fName = $("#fname").val();
        rValues.lname = $("#lname").val();
        rValues.email = $("#email").val();
        rValues.uname = $("#uname").val();
        rValues.pass = $("#pass").val();
        console.log(" rValues " + JSON.stringify(rValues));
...
<div class="testbox">
    ...
    <button class="button" name="subject" type="submit" value="Login" onclick="submitRegistration()"> Register </button>
